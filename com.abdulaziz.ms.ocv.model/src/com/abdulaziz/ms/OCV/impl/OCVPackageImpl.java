...
public class OCVPackageImpl extends EPackageImpl implements OCVPackage {
	 ...
	 * @generated
	 */
	private EClass vContractCollectionBoxEClass = null;
	 ...
	 * @generated
	 */
	public EReference getVOperation_VcContractCollection() {
		return (EReference)vOperationEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getVCAssociation_Directional() {
	 ...
	 * @generated
	 */
	public EReference getVCCollectionBox_VContractCollectionBox() {
		return (EReference)vcCollectionBoxEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getVCLoop_VcContractLoopBox() {
		return (EReference)vcLoopEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getConditionOption_VcEntityReference() {
		return (EReference)conditionOptionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getConditionOption_DisplayedConditionStatement() {
		return (EAttribute)conditionOptionEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getConditionOption_ConditionValue() {
		return (EAttribute)conditionOptionEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getConditionOption_MeaningOfConditionStatement() {
		return (EAttribute)conditionOptionEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EClass getVContractCollectionBox() {
		return vContractCollectionBoxEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getVContractCollectionBox_VcCollectionBox() {
		return (EReference)vContractCollectionBoxEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getVContractLoopBox() {
		return vContractLoopBoxEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getVContractLoopBox_VcCollectionBox() {
		return (EReference)vContractLoopBoxEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(vOperationEClass, VOPERATION__VC_CONTRACT_COLLECTION);
		...
		createEReference(vcCollectionBoxEClass, VC_COLLECTION_BOX__VCONTRACT_COLLECTION_BOX);

		vcLoopEClass = createEClass(VC_LOOP);
		createEAttribute(vcLoopEClass, VC_LOOP__ITERATION);
		createEReference(vcLoopEClass, VC_LOOP__VC_CONTRACT_LOOP_BOX);
		...
		createEReference(conditionOptionEClass, CONDITION_OPTION__VC_ENTITY_REFERENCE);
		...
		vContractCollectionBoxEClass = createEClass(VCONTRACT_COLLECTION_BOX);
		createEReference(vContractCollectionBoxEClass, VCONTRACT_COLLECTION_BOX__VC_COLLECTION_BOX);
	...
	public void initializePackageContents() {
		...
		initEReference(getVOperation_VcContractCollection(), this.getVCContract(), null, "vcContractCollection", null, 0, -1, VOperation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getVCLoop_VcContractLoopBox(), this.getVContractLoopBox(), this.getVContractLoopBox_VcCollectionBox(), "vcContractLoopBox", null, 0, 1, VCLoop.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
