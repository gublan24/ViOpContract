...
/**
 * This is the item provider adapter for a {@link com.abdulaziz.ms.OCV.VCLoop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VCLoopItemProvider
	 ...
	 * @generated
	 */
	public VCLoopItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VCLoop_iteration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VCLoop_iteration_feature", "_UI_VCLoop_type"),
				 OCVPackage.Literals.VC_LOOP__ITERATION,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VCLoop"));
	}
	...
	public String getText(Object object) {
		String label = ((VCLoop)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VCLoop_type") :
			getString("_UI_VCLoop_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VCLoop.class)) {
